...
import { Button, Card, CardBody, Image, Divider, Input } from '@nextui-org/react';
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex flex-col items-center justify-center gap-6 p-6">
          <ShoppingBag size={100} className="text-default-300" />
          <h1 className="text-3xl font-bold">Ваша корзина пуста</h1>
          <p className="text-default-500">Посмотрите наш каталог, чтобы найти что-то интересное.</p>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-black">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-6 py-12">
        <h1 className="text-4xl font-bold mb-10 uppercase tracking-tighter">Корзина</h1>
